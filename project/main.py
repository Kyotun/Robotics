...
from project.modules.world_helpers import WorldHelper
from project.modules.cli import parse_args
...
if __name__ == "__main__":
    ...
    def thread_func():
        ...
        problem_file = world_helper.generateProblemPDDL(problem_for_pddl="main-problem",
                                                        domain_for_pddl="main-domain")
